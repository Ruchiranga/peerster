...
./peerster -UIPort=12000 -gossipAddr=127.0.0.1:5000 -name=A -peers=127.0.0.1:5001,127.0.0.1:5019  -rtimer=$v > peersterA.out &
...
./peerster -UIPort=12014 -gossipAddr=127.0.0.1:5014 -name=O -peers=127.0.0.1:5013,127.0.0.1:5015  -rtimer=$v > peersterO.out &
./peerster -UIPort=12015 -gossipAddr=127.0.0.1:5015 -name=P -peers=127.0.0.1:5014,127.0.0.1:5016  -rtimer=$v > peersterP.out &
./peerster -UIPort=12016 -gossipAddr=127.0.0.1:5016 -name=Q -peers=127.0.0.1:5015,127.0.0.1:5017  -rtimer=$v > peersterQ.out &
./peerster -UIPort=12017 -gossipAddr=127.0.0.1:5017 -name=R -peers=127.0.0.1:5016,127.0.0.1:5018  -rtimer=$v > peersterR.out &
./peerster -UIPort=12018 -gossipAddr=127.0.0.1:5018 -name=S -peers=127.0.0.1:5017,127.0.0.1:5019  -rtimer=$v > peersterS.out &
./peerster -UIPort=12019 -gossipAddr=127.0.0.1:5019 -name=T -peers=127.0.0.1:5018,127.0.0.1:5000  -rtimer=$v > peersterT.out &
